...
style_2_image = pygame.image.load("assets/style_pallet22.png")
brush_img = pygame.image.load("assets/brush_white.png")
brush_image2 = pygame.image.load("assets/brush_black.png")
font = pygame.font.SysFont('candara',18)
font2 = pygame.font.SysFont('candara',48)
font4 = pygame.font.SysFont('candara',24)
font3 = pygame.font.SysFont('Comic Sans',20)
font.set_bold(True)
font2.set_bold(True)
font4.set_bold(True)
...
def draw(x, y, px, py, z, color_index, brush_size, bg_color):        
    if z and x > (200 + brush_size):
        ...
        if delta > 3 or brush_size > 2:
            ell = pygame.Rect(x,y,abs(px-x)+brush_size,abs(py-y)+brush_size)
            pygame.draw.ellipse( screen, COLORS[color_index], ell) 
            pygame.display.update()
            ell = pygame.Rect(WIDTH-x+200,HEIGHT-y,abs(px-x)+brush_size,abs(py-y)+brush_size)
            pygame.draw.ellipse( screen, COLORS[abs(7-color_index)], ell) 
            pygame.display.update()
        else:
            pygame.draw.circle(screen, COLORS[color_index], (x,y), brush_size) 
            pygame.draw.circle(screen, COLORS[7-color_index], (WIDTH-x+200,HEIGHT-y), brush_size)
            pygame.display.update()
    return x, y
...
def drizzle(x, y, z, bg_color):
    if z and x > (200 + brush_size):
        ...
        y = y + recty_adj
        if x > 200:
            pygame.draw.circle(screen, COLORS[rand_color], (x,y), rand_rad) 
        if WIDTH - x + 200 > 200:
            pygame.draw.circle(screen, COLORS[rand_color2], (WIDTH - x + 200,HEIGHT - y), rand_rad2)  
...
if __name__ == '__main__':             
    ...
    back_rect = pygame.Rect(50, 50, 130, 130)
    next_rect = pygame.Rect( 20, 650, 150, 30)
    next2_rect = pygame.Rect( 1130, 660, 80, 80)
    style0_rect = pygame.Rect(58, 220, 80, 80)
    style1_rect = pygame.Rect(48, 308, 104, 76)
    style2_rect = pygame.Rect(48, 398, 104, 76)
    frame_rect = pygame.Rect(0,0,200, HEIGHT) 
    init_p = True
    master_loop = True
    ...
    while master_loop:
        ...
        pygame.display.update() 
        if again:
            this_image = pygame.image.load("PollockImage0.png")
        ...
        while push:        
            ...
            if pallet_flag == 0:
                pygame.draw.rect(screen, COLORS[0], style0_rect, 3, 1)
                pygame.draw.rect(screen, COLORS[0], style1_rect, 1, 1)
                pygame.draw.rect(screen, COLORS[0], style2_rect, 1, 1)
        
            screen.blit(style_1_image, (50,310))
            if pallet_flag == 1:
                pygame.draw.rect(screen, COLORS[0], style0_rect, 1, 1)
                pygame.draw.rect(screen, COLORS[0], style1_rect, 3, 1)
                pygame.draw.rect(screen, COLORS[0], style2_rect, 1, 1)
            ...
            if pallet_flag == 2:
                pygame.draw.rect(screen, COLORS[0], style0_rect, 1, 1)
                pygame.draw.rect(screen, COLORS[0], style1_rect, 1, 1)
                pygame.draw.rect(screen, COLORS[0], style2_rect, 3, 1)
            pygame.display.update()
            pygame.draw.rect(screen, COLORS[0], frame_rect, 3, 1)
            pygame.display.update()
            clr_text = font.render("Pallet", True, COLORS[0])
            screen.blit(clr_text, ( 70, 190))
            pygame.display.update()

            Reset_button = pygame.draw.rect(screen, COLORS[0], reset_rect, 3, 5)
            clr_text = font.render("Reset", True, COLORS[0])
            screen.blit(clr_text, ( 70, 612))
            pygame.display.update()

            pygame.draw.rect(screen, (47,86,223), next_rect)
            Next_button = pygame.draw.rect(screen, (136,206,236), next_rect, 3, 7)
        ...
        input_qty1 = pygame.Rect(383, 270, 35, 25)
        input_qty2 = pygame.Rect(383, 418, 35, 25)
        input_qty3 = pygame.Rect(383, 566, 35, 25)
        input_qty4 = pygame.Rect(755, 268, 35, 25)
        input_qty5 = pygame.Rect(1044, 530, 35, 25)
        artist_rect = pygame.Rect(750, 655, 250, 35)
        
        sm_rect = pygame.Rect((180, 200), (80, 100))        
        med_rect = pygame.Rect((125, 340), (140, 100))
        lg_rect = pygame.Rect((700, 100), (200, 240))
        xlg_rect = pygame.Rect((700, 440), (360, 240))
        screen = pygame.Surface.subsurface(screen, 200, 0, WIDTH-200, HEIGHT)
        this_image = pygame.image.save(screen, "PollockImage0.png".format(imagecount))
        imagecount += 1
        push2 = True
        ...
        pygame.draw.circle(screen, COLORS[7], (310, 278), 10, 2)    
        pygame.draw.circle(screen, COLORS[0], (310, 278), 8, 8)  
        pygame.draw.circle(screen, COLORS[7], (310, 428), 10, 2) 
        pygame.draw.circle(screen, COLORS[0], (310, 428), 8, 8) 
        pygame.draw.circle(screen, COLORS[7], (310, 578), 10, 2) 
        pygame.draw.circle(screen, COLORS[0], (310, 578), 8, 8) 
        pygame.draw.circle(screen, COLORS[7], (680, 278), 10, 2) 
        pygame.draw.circle(screen, COLORS[0], (680, 278), 8, 8) 
        pygame.draw.circle(screen, COLORS[7], (970, 538), 10, 2) 
        pygame.draw.circle(screen, COLORS[0], (970, 538), 8, 8) 
        ...
        pygame.draw.rect(screen, color_passive, input_qty1)
        pygame.draw.rect(screen, COLORS[7], input_qty1, 1, 1)
        pygame.draw.rect(screen, color_passive, input_qty2)
        pygame.draw.rect(screen, COLORS[7], input_qty2, 1, 1)
        pygame.draw.rect(screen, color_passive, input_qty3)
        pygame.draw.rect(screen, COLORS[7], input_qty3, 1, 1)
        pygame.draw.rect(screen, color_passive, input_qty4)
        pygame.draw.rect(screen, COLORS[7], input_qty4, 1, 1)
        pygame.draw.rect(screen, color_passive, input_qty5)
        pygame.draw.rect(screen, COLORS[7], input_qty5, 1, 1)   
        pygame.draw.rect(screen, color_passive, artist_rect)
        pygame.draw.rect(screen, COLORS[7], artist_rect, 1, 1)   
        pygame.display.update()  

        sm_rect = pygame.Rect((180, 200), (80, 100))        
        med_rect = pygame.Rect((125, 340), (140, 100))
        lg_rect = pygame.Rect((700, 470), (200, 240))
        xlg_rect = pygame.Rect((700, 440), (360, 240))
        button_rect1 = pygame.Rect(300, 270, 80, 80)
        button_rect2 = pygame.Rect(300, 419, 80, 80)
        button_rect3 = pygame.Rect(300, 569, 80, 80)
        button_rect4 = pygame.Rect(670, 268, 80, 80)
        button_rect5 = pygame.Rect(960, 527, 80, 80)    
        user_text1 = ''
        user_text2 = ''
        user_text3 = ''
        user_text4 = ''
                ...
                if event.type == pygame.QUIT:
                    ...
                    if button_rect1.collidepoint(pygame.mouse.get_pos()):                            
                        if screen.get_at((310, 278)) == COLORS[0]:  
                            ...
                            active6 = False
                            color = color_active
                            pygame.draw.circle(screen, COLORS[7], (310, 278), 10, 10)                              
                        else:
                            active1 = False
                            color = color_passive
                            pygame.draw.circle(screen, COLORS[7], (310, 278), 10, 2)  
                            pygame.draw.circle(screen, COLORS[0], (310, 278), 8, 8)                              
                            user_text1 = '' 
                        pygame.draw.rect(screen, color, input_qty1)
                        pygame.draw.rect(screen, COLORS[7], input_qty1, 1, 1)
                        pygame.display.update()
                    ...
                    if button_rect2.collidepoint(pygame.mouse.get_pos()):
                        ...
                        if screen.get_at((310, 430)) == COLORS[0]:
                            pygame.draw.circle(screen, COLORS[7], (310, 428), 10, 10)
                            color = color_active
                        else:
                            active2 = False
                            color = color_passive
                            ...
                            pygame.draw.circle(screen, COLORS[0], (310, 428), 8, 8)                            
                            user_text2 = ''
                        pygame.draw.rect(screen, color, input_qty2)
                        pygame.draw.rect(screen, COLORS[7], input_qty2, 1, 1)
                    ...
                    if button_rect3.collidepoint(pygame.mouse.get_pos()):
                        ...
                        if screen.get_at((310, 578)) == COLORS[0]:
                            pygame.draw.circle(screen, COLORS[7], (310, 578), 10, 10)
                            color = color_active
                        else:
                            active3 = False
                            color = color_passive
                    ...
                    if input_qty3.collidepoint(pygame.mouse.get_pos()):
                        ...
                        color = color_active
                        pygame.draw.circle(screen, COLORS[7], (310, 578), 10, 10) 
                        pygame.draw.rect(screen, color, input_qty3)
                        pygame.draw.rect(screen, COLORS[7], input_qty3, 1, 1)
                        pygame.display.update()
                    ...
                    if button_rect4.collidepoint(pygame.mouse.get_pos()):
                        ...
                        if screen.get_at((678, 278)) == COLORS[0]:
                            pygame.draw.circle(screen, COLORS[7], (680, 278), 10, 10)                            
                            pygame.draw.rect(screen, COLORS[7], input_qty4, 1, 1)
                            color = color_active
                        else:
                            pygame.draw.circle(screen, COLORS[7], (680, 278), 10, 2)  
                            pygame.draw.circle(screen, COLORS[0], (680, 278), 8, 8)
                            color = color_passive
                        pygame.draw.rect(screen, color, input_qty4)
                        pygame.draw.rect(screen, COLORS[7], input_qty4, 1, 1)
                        user_text4 = ''
                    ...
                    if button_rect5.collidepoint(pygame.mouse.get_pos()):
                        ...
                        if screen.get_at((970, 538)) == COLORS[0]:
                            pygame.draw.circle(screen, COLORS[7], (970, 538), 10, 10)
                            color = color_active
                        else:
                            pygame.draw.circle(screen, COLORS[7], (970, 538), 10, 2)  
                            pygame.draw.circle(screen, COLORS[0], (970, 538), 8, 8) 
                            color = color_passive
                        pygame.draw.rect(screen, color, input_qty5)
                        pygame.draw.rect(screen, COLORS[7], input_qty5, 1, 1)
                        user_text5 = ''
                    ...
                    if artist_rect.collidepoint(pygame.mouse.get_pos()):
                        active6 = True
                        color = color_active
                        pygame.draw.rect(screen, color, artist_rect)
                        pygame.draw.rect(screen, COLORS[7], artist_rect, 1, 1)
                        pygame.display.update()
        ...
        while push3:
            clock.tick(30) 
            image = pygame.image.load("PollockImage0.png")      
